...
cv2.imwrite("friends_dft_numpy_mask.png", mask)
cv2.imwrite("friends_dft_numpy_mask_blurred.png", mask2)
cv2.imwrite("friends_dft_numpy_roundtrip.png", img_back)
cv2.imwrite("friends_dft_numpy_lowpass_filtered1.png", img_filtered)
cv2.imwrite("friends_dft_numpy_lowpass_filtered2.png", img_filtered2)